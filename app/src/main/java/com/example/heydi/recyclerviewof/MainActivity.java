package com.example.heydi.recyclerviewof;
...
public class MainActivity extends AppCompatActivity implements ContactsAdapter.ContactsAdapterListener {
    ...
    // url para buscar contactos json
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // cosas de lujo de la barra de herramientas
        ...
        //barra de notificación de fondo blanco
    ...
    private void fetchContacts() {
        ...
        MyApplication.getInstace().addToRequestQueue(request);
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        //escuchando el cambio de texto de consulta de búsqueda
